...
| 웹 클라이언트 | `/Users/tgkang/repository/oxlens-home` | Vanilla JS + Tailwind. 활성 SDK = sdk/ (전면 재작성, 설계 20260603). 구 core/ 는 `__core_deprecated__/` 로 개명(0620, 죽은 화석) |
...
- **SDK 글루 검증 (oxlens-home/sdk/tests/, 0613 일원화)**: node mock 체크 20종(`node sdk/tests/<name>_check.mjs`) — 실 webrtc 없이 배선/계약 검증. 커밋 전 전체 PASS 의무.
